...
def setup_youtube_cookies():
    """
    Set up YouTube cookies from YOUTUBE_COOKIES environment variable.
    The cookies should be in EditThisCookie JSON format.
    Writes cookies to /app/cookies/youtube.txt in Netscape format for yt-dlp.
    """
    ...
    try:
        ...
        print(f"[CONFIG] YouTube cookies loaded from YOUTUBE_COOKIES env var")
